...
namespace ABP.Tests.WithMock.EF.CRUD
{
    public class ExperimentEFTests
    {
        private IMapper _mapper;

        private Mock<IExperimentEFRepository> _repo;

        private ExperimentCRUD_EFController _controller;

        [SetUp]
        public void Setup()
        {
            _repo = ExperimentDataOperator.CreateMockEFRepo();

            _mapper = MapperConfig.InitializeAutomapper();

            _controller = new ExperimentCRUD_EFController(_repo.Object, _mapper);
        }
