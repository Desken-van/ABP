...
{
    public class DeviceEFTests
    {
        private IMapper _mapper;

        private Mock<IDeviceEFRepository> _device_repo;
        ...
        public void Setup()
        {
            _device_repo = DeviceDataOperator.CreateMockEFRepo();

            _mapper = MapperConfig.InitializeAutomapper();

            _controller = new DeviceCRUD_EFController(_device_repo.Object, _mapper);
        }
