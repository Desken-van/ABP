...
{
    public class TokenEFTests
    {
        private IMapper _mapper;

        private Mock<IDeviceTokenEFRepository> _repo;
        ...
        public void Setup()
        {
            _repo = TokenDataOperator.CreateMockEFRepo();

            _mapper = MapperConfig.InitializeAutomapper();

            _controller = new DeviceTokenCRUD_EFController(_repo.Object, _mapper);
        }
